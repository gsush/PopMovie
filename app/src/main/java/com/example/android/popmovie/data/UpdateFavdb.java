...
//
//import static com.example.android.popmovie.Network.FetchMoviesTask.mcontext;
//
...
//
//    public UpdateFavdb(Context context){
//        mContext= context;
//    }
//
//    @Override
...
//                //new String[]{MovieList.getId()}, null);
...
//           // movieValues.put(MovieContract.MovieEntry.COLUMN_MOVIE_ID, MovieList.getId());
